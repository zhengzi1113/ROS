...
message(STATUS "hello: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ihello:/home/xiang/test/src/hello/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/xiang/test/src/hello/msg/Person.msg" NAME_WE)
add_custom_target(_hello_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hello" "/home/xiang/test/src/hello/msg/Person.msg" ""
)
...
_generate_msg_cpp(hello
  "/home/xiang/test/src/hello/msg/Person.msg"
  "${MSG_I_FLAGS}"
  ""

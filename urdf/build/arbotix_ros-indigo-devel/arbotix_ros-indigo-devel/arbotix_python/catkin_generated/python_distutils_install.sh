...
echo_and_run cd "/home/xiang/urdf/src/arbotix_ros-indigo-devel/arbotix_ros-indigo-devel/arbotix_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/xiang/urdf/src/arbotix_ros-indigo-devel/arbotix_ros-indigo-devel/arbotix_python/setup.py" \
     \
    build --build-base "/home/xiang/urdf/build/arbotix_ros-indigo-devel/arbotix_ros-indigo-devel/arbotix_python" \
    install \
    --root="${DESTDIR-/}" \
